...
const Clients = () => {
  return (
    <main id="clients" className="md:max-w-full max-w-full md:h-[788px] h-[722px] bg-center bg-cover md:gap-2 gap-2" style={{ backgroundImage: `url(${plate})` }}>
          ...
          <div className="md:w-[635px] md:h-[174px] md:gap-[16px] w-[330px] h-[162px] gap-[8px] flex flex-col">
            <div>
              <div className="flex items-center gap-[10px] md:w-[635px] md:h-[32px] w-[330px] h-[26px]">
                <img src={rectangle} alt="" className="w-[10px] h-[10px] bg-[#BD1F17]"/>
